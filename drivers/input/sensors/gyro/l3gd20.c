...
struct sensor_operate gyro_l3gd20_ops = {
	.name				= "l3gd20",
	.type				= SENSOR_TYPE_GYROSCOPE,//sensor type and it should be correct
	.id_i2c				= GYRO_ID_L3GD20,		//i2c id number
...
{
	return &gyro_l3gd20_ops;
}


static int __init gyro_l3gd20_init(void)
{
...
static void __exit gyro_l3gd20_exit(void)
{
	struct sensor_operate *ops = gyro_get_ops();
	int type = ops->type;
...
module_init(gyro_l3gd20_init);
module_exit(gyro_l3gd20_exit);
